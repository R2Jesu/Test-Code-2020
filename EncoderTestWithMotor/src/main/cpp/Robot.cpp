...
class Robot : public frc::TimedRobot {
 public:
  Robot() {
    ...
    m_encoder.SetDistancePerPulse(1.0 / 2048.0 * 2.0 * wpi::math::pi * 1.0);
 ...
 private:
  ...
  // MLH: Change address from 1 & 2 to 7 & 8
  frc::Encoder m_encoder{7, 8, false, frc::Encoder::k4X};

  static const int leftPwmChannel = 9;
  rev::SparkMax m_encMotor{leftPwmChannel};
